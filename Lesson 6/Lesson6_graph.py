...
from Lesson6_grid_display import *
from Lesson6_bfs import *
...
class GridGraph(object):
    ...
    def compute_node_locations(self):
        ...
        for key in self.nodes:
            ...
            # canvas.create_oval(col*100-r + 100, row*100-r + 100, col*100+r + 100, row*100+r + 100)
            # canvas.create_oval(col*100 + 110, row*100 + 410, col*100 + 90, row*100 + 390)
            # canvas.create_oval(col*100 + 95, row*100 + 395, col*100 + 105, row*100 + 405)
            # print row-r + 100, col-r + 100, row+r + 100, col+r + 100
        # root.mainloop()
...
def main():
    ...
    root = tk.Tk()
    graph_display = GridGraphDisplay(root, graph)
